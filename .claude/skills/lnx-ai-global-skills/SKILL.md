...
allowed-tools:
  ...
  - Write
  - Bash
argument-hint: "lib-link <path>... | harness-link <name>... | lib-pull <name>... | list-global | list-local | lib-unlink <name>... | harness-unlink <name>... | full-unlink <name>... | replace <name> <path>"
---
