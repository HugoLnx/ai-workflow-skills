...
Use this reference when migrating existing harness skill configurations to the lnx-multi-ai `.ai/skills/` format.
...
2. Note whether the body is `@content.md` (already in lnx-multi-ai format) or inline content (needs migration)
