...
Always edit `.ai/project-context.md` — never edit `CLAUDE.md`, `AGENTS.md`, `.cursorrules`, or `.github/copilot-instructions.md` directly. Those are symlinks; edits to them would modify the source file anyway, but lnx-multi-ai-wall will intercept any direct write attempts and redirect here.
