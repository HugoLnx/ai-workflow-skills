#!/usr/bin/env python3
"""skills-lib — install, list, and remove AI skills from global harness folders."""
...
def cmd_lib_pull(args):
    ...
    build_script = cwd / ".ai/skills/multi-ai/scripts/build-skills.py"
...
def main():
    ...
    if args.command is None:
        print("skills-lib — manage AI skills across global harness folders\n")
        print("Commands:")
        ...
        print("\nRun 'skills-lib <command> --help' for command details.")
        return
