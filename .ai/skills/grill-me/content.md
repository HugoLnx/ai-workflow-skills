...
```
/grill-me @security @domain-expert "user auth flow"
```
...
```mermaid
flowchart TD
  Start["/grill-me [topic] [@specialists]"] --> GrillerKnown{Griller type\nspecified?}
