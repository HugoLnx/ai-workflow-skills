...
- `@skills-lib` — install, list, and remove skills from global harness folders (`~/.claude/skills/`, `~/.agents/skills/`, `~/.cursor/skills/`, `~/.copilot/skills/`); supports listing local project skills with per-harness build status
